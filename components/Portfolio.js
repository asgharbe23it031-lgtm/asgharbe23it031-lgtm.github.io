...
const PROJECTS = [
  {
    ...
    description: 'A modern mobile platform bridging Worshipers and Religious Leaders. Features personalized feeds, reels, direct messaging, and community engagement with Firebase backend.',
    tags: ['Flutter', 'Firebase', 'Provider', 'GetX', 'Cloud Firestore', 'Google Auth'],
    images: [
    ...
    accentColor: 'purple',
    stats: { users: '2 Roles', engagement: 'Real-time', content: 'Posts & Reels' },
              ...
              <div className="overflow-y-auto p-6 sm:p-8 md:p-10">
                ...
                <div className="mb-8">
                  ...
                  >
                    ...
                    <p className="text-base sm:text-lg opacity-80 max-w-3xl mb-4">
                    ...
                    {selectedProject.github && (
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gray-800/50 border border-gray-700 hover:border-purple-500 transition-colors text-sm"
                      >
